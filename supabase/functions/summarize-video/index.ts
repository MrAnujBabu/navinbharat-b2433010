...
- Student ko batao ki better results ke liye lesson ka description available hona chahiye.`;
    ...
    let prompt = "";
    let systemPrompt = `You are Safar Sarthi, the AI learning companion for Naveen Bharat coaching platform. You help Indian students preparing for NEET/JEE/Board exams.
...
${groundingInstruction}`;
    ...
    if (mode === "research") {
      systemPrompt = `You are Safar Sarthi, an expert educational researcher for Naveen Bharat platform. You do deep conceptual analysis for NEET/JEE/Board exam students.
