...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Students = rows in user_roles with role 'student' — the SAME source the
    // admin dashboard uses. Counting `profiles` here made /dashboard show 7
    // while /admin showed 6 (admin/teacher profiles were included).
