...
export function CollapsiblePdfSection({
  ...
  onClosePdf: () => void;
  /** Used as the readable fallback when a PDF's file name is a storage id. */
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">
                  {pdfDisplayName(pdf.file_name, [lessonTitle])}
                </p>
          ...
          {selectedPdf && (
            <div className="relative">
              ...
              <PdfViewer
                ...
                title={pdfDisplayName(selectedPdf.file_name, [lessonTitle])}
