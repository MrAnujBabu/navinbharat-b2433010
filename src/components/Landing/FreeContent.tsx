...
const freePdfs = [
  { title: "NEET Biology — NCERT Line-by-Line Notes", meta: "PDF · 42 pages", href: "/books" },
  { title: "Physics — Formula Revision Booklet", meta: "PDF · 18 pages", href: "/books" },
  { title: "Organic Chemistry — Reaction Map", meta: "PDF · 64 pages", href: "/books" },
  { title: "NEET PYQ — 10 Saal Chapter-wise", meta: "PDF · 24 pages", href: "/books" },
  { title: "Human Physiology Practice Set", meta: "PDF · 30 pages", href: "/books" },
  { title: "Inorganic Chemistry Quick Revision", meta: "PDF · 8 pages", href: "/books" },
];

const freeTests = [
  { title: "NEET Biology — Mock 1", meta: "30 questions · 30 min", href: "/courses" },
  { title: "Physics — Diagnostic Test", meta: "25 questions · 20 min", href: "/courses" },
  { title: "Chemistry PYQ Quiz", meta: "40 questions · 45 min", href: "/courses" },
];
