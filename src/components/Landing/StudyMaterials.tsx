...
const resources = [
  { tag: "Notes", title: "NEET Biology — Complete NCERT Notes", desc: "Chapter-wise summaries, diagrams aur exam-ready revision sheets." },
  { tag: "Practice", title: "Physics + Chemistry Daily DPP", desc: "1,200+ questions difficulty-wise graded, detailed solutions ke saath." },
  { tag: "Mock Tests", title: "NEET Full-Length Test Series", desc: "Timed full papers with detailed analysis and topic-wise scoring." },
];
