...
const ribbonFor = (label: string): string => {
  ...
  if (s.includes("11")) return "from-indigo-500 to-blue-500";
  if (s.includes("12")) return "from-emerald-500 to-teal-500";
  if (s.includes("dropper") || s.includes("repeat")) return "from-amber-500 to-orange-500";
  if (s.includes("biology") || s.includes("neet")) return "from-rose-500 to-pink-500";
      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-10">
        <div className="max-w-2xl mb-10 md:mb-14">
          ...
          <p className="text-muted-foreground mt-4 text-base md:text-lg leading-relaxed">
            Naveen Bharat ke saath — chapter-wise videos, DPP, weekly tests aur daily doubt support.
          </p>
        </div>
