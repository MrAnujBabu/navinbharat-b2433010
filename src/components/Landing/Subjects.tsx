...
const featured = [
  {
    tag: "NEET · Biology",
    title: "Biology NCERT Line-by-Line + Diagrams",
    instructor: "Naveen Bharat faculty",
    duration: "20 weeks · 180+ lessons",
  },
  {
    tag: "NEET · Chemistry",
    title: "Physical, Inorganic & Organic — Full Course",
    instructor: "Naveen Bharat faculty",
    duration: "18 weeks · 150+ lessons",
  },
  {
    tag: "NEET · Physics",
    title: "Concepts + Numericals with PYQ Drill",
    instructor: "Naveen Bharat faculty",
    duration: "18 weeks · 140+ lessons",
  },
];
    ...
    <div className="container mx-auto max-w-7xl px-6 lg:px-10">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
        <div className="max-w-2xl">
          ...
          >
            NEET ke teeno subject — Physics, Chemistry, Biology.
          </h2>
        </div>
        <Link
          to="/courses"
