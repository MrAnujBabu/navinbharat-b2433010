...
const features = [
  { icon: BookOpen, title: "Structured Curriculum", desc: "Poora NEET syllabus — NCERT line-by-line Physics, Chemistry aur Biology." },
  ...
  { icon: Award, title: "Proven Results", desc: "Har saal NEET qualifiers — Class 11, Class 12 aur droppers." },
];
