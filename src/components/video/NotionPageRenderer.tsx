 ...
 */
function pruneEmptyBlocks<T extends { block?: Record<string, any> }>(recordMap: T): T {
...
export default function NotionPageRenderer({ url, title, onClose, onReady, onDocument }: Props) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setRecordMap(pruneEmptyBlocks(recordMap as any) as Parameters<typeof setRecordMap>[0]);
