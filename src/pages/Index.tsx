...
const defaultHeroData: HeroData = {
  title: "NEET ka pura syllabus. Ek disciplined system.",
  subtitle:
    ...
    <div className="min-h-dvh bg-background">
      ...
      <main style={{ paddingTop: "calc(4rem + env(safe-area-inset-top))" }}>
        ...
        <Suspense fallback={<div className="min-h-[200px]" aria-hidden />}>
          <section id="exam-tracks" aria-label="Exam batches" className="cv-auto"><ExamTracks /></section>
          <section aria-label="Free resources" className="cv-auto"><FreeContent /></section>
          <section aria-label="Student results" className="cv-auto"><Testimonials /></section>
          <section id="why-choose-us" aria-label="Our method" className="cv-auto"><WhyChooseUs /></section>
          <section aria-label="Get started" className="cv-auto"><GraduationBanner /></section>
          <section id="community" aria-label="Join our community" className="cv-auto"><CommunityStrip /></section>
